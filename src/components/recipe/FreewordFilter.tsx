              ...
              <div className="flex gap-2">
                ...
                {filters.freeword && (
                  <button
                    ...
                    disabled={isLoading}
                    className="px-3 py-2 text-gray-600 rounded-lg text-sm font-medium bg-gray-200 hover:bg-gray-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 flex items-center"
                  >
                    <X className="w-4 h-4" />
                  </button>
                )}
